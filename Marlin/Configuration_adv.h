 ...
 */
#define FAN_PIN MALYAN_FAN1_PIN // Malyan M200: uncomment if you use FAN1 to cool the part
...
#define E0_AUTO_FAN_PIN -1 // Malyan M200: uncomment if you use a hard wired Fan to cool the extruder
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 255
